...
--- 2 Procurando Nemo foi aclamado pela crítica! Foi classificado em 6.8, fez 450 milhões
--- no mercado interno e 370 milhões no mercado internacional. Adicione as informações
--- à tabela BoxOffice .
INSERT INTO
  BoxOffice(
    movie_id,
...
-- 3 O diretor do filme "Procurando Nemo" está incorreto,
-- na verdade ele foi dirigido por Andrew Staton.Corrija esse dado utilizando o
-- UPDATE
UPDATE
  Pixar.Movies
SET
...
-- além disso, o filme foi lançado em 2007 e não em 2010. Corrija esses dados
-- utilizando o UPDATE .
UPDATE
  Pixar.Movies
SET
...
-- 8  Altere a classificação da tabela BoxOffice para 9.0 de todos os
...
-- 9  Altere a classificação da tabela BoxOffice para 6.0 de todos os
-- filmes que lucraram menos de 300 milhões no mercado internacional e
